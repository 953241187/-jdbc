...
public class FrmyouhuiManager extends JDialog implements ActionListener {
	...
	private Object tblTitle[]={"优惠券编号","优惠券金额","开始时间","结束时间"};
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==this.btnAdd){
			FrmyouhuiManager_Add dlg=new FrmyouhuiManager_Add(this,"添加商家",true);
			dlg.setVisible(true);
			if(dlg.getPub()!=null){//刷新表格
				...
				if(JOptionPane.showConfirmDialog(this,"确定删除"+p.getYouhuiquan_id()+"吗？","确认",JOptionPane.YES_NO_OPTION)==JOptionPane.YES_OPTION){
					try {
