...
public class FrmdingManager1_create extends JDialog implements ActionListener{
	private dingdan ding=null;
	private JPanel toolBar = new JPanel();
	private JPanel workPane = new JPanel();
	private Button btnOk = new Button("确定");
	private Button btnCancel = new Button("取消");
	private JLabel labelPdtid = new JLabel("订单编号");
	private JLabel labelUser = new JLabel("用户编号");
	private JLabel labelAddress = new JLabel("地址编号");
	...
	public FrmdingManager1_create(FrmdingManager1 f, String s, boolean b) {
		super(f, s, b);
