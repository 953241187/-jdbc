...
public class FrmdingManager1_queren extends JDialog implements ActionListener{
	private dingdan ding=null;
	private JPanel toolBar = new JPanel();
	private JPanel workPane = new JPanel();
	private Button btnOk = new Button("确定");
	private Button btnCancel = new Button("取消");
	private JLabel labelPdtid = new JLabel("请输入要下单的订单号:");
	
	private JTextField edtPdtid = new JTextField(20);
	public FrmdingManager1_queren(FrmdingManager1 f, String s, boolean b) {
		super(f, s, b);
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==this.btnCancel) {
			...
			try {
				(new yaoqiu11()).querenxiadan(ding);
				this.setVisible(false);
