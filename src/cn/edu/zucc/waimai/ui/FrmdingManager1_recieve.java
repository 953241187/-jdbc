...
public class FrmdingManager1_recieve extends JDialog implements ActionListener{
	...
	private JLabel labelPdtid = new JLabel("请输入接收的订单号:");
	public FrmdingManager1_recieve(FrmdingManager f, String s, boolean b) {
		super(f, s, b);
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==this.btnCancel) {
			...
			try {
				(new yaoqiu11()).jieshoudingdan(ding);
				this.setVisible(false);
